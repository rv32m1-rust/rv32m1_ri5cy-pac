...
impl R {
  ...
  pub fn txwater(&self) -> TXWATER_R {
    TXWATER_R::new((self.bits & 0x07) as u8)
  }
  #[doc = "Bits 8:11 - Transmit Counter"]
  #[inline(always)]
  pub fn txcount(&self) -> TXCOUNT_R {
    TXCOUNT_R::new(((self.bits >> 8) & 0x0f) as u8)
  }
  #[doc = "Bits 16:18 - Receive Watermark"]
  #[inline(always)]
  pub fn rxwater(&self) -> RXWATER_R {
    RXWATER_R::new(((self.bits >> 16) & 0x07) as u8)
  }
  #[doc = "Bits 24:27 - Receive Counter"]
  #[inline(always)]
  pub fn rxcount(&self) -> RXCOUNT_R {
    RXCOUNT_R::new(((self.bits >> 24) & 0x0f) as u8)
  }
}
impl W {
  #[doc = "Bits 0:2 - Transmit Watermark"]
