#[doc = "Reader of register CRS1"]
pub type R = crate::R<u32, super::CRS1>;
#[doc = "Writer for register CRS1"]
pub type W = crate::W<u32, super::CRS1>;
#[doc = "Register CRS1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CRS1 {
  type Type = u32;
  #[inline(always)]
