#[doc = "Reader of register CRS4"]
pub type R = crate::R<u32, super::CRS4>;
#[doc = "Writer for register CRS4"]
pub type W = crate::W<u32, super::CRS4>;
#[doc = "Register CRS4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CRS4 {
  type Type = u32;
  #[inline(always)]
