#[doc = "Reader of register CRS0"]
pub type R = crate::R<u32, super::CRS0>;
#[doc = "Writer for register CRS0"]
pub type W = crate::W<u32, super::CRS0>;
#[doc = "Register CRS0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CRS0 {
  type Type = u32;
  #[inline(always)]
