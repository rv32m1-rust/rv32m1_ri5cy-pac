#[doc = "Reader of register CRS2"]
pub type R = crate::R<u32, super::CRS2>;
#[doc = "Writer for register CRS2"]
pub type W = crate::W<u32, super::CRS2>;
#[doc = "Register CRS2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CRS2 {
  type Type = u32;
  #[inline(always)]
