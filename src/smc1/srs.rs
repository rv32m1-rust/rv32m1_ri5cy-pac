...
#[doc = "Core0 System Reset\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CORE0_A {
  #[doc = "0: Reset not generated from Core0 system reset source."]
  CORE0_0,
  #[doc = "1: Reset generated from Core0 system reset source."]
  CORE0_1,
}
