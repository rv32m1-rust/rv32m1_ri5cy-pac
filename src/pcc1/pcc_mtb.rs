#[doc = "Reader of register PCC_MTB"]
pub type R = crate::R<u32, super::PCC_MTB>;
#[doc = "Writer for register PCC_MTB"]
pub type W = crate::W<u32, super::PCC_MTB>;
#[doc = "Register PCC_MTB `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_MTB {
  type Type = u32;
  #[inline(always)]
