#[doc = "Reader of register PCC_DMAMUX1"]
pub type R = crate::R<u32, super::PCC_DMAMUX1>;
#[doc = "Writer for register PCC_DMAMUX1"]
pub type W = crate::W<u32, super::PCC_DMAMUX1>;
#[doc = "Register PCC_DMAMUX1 `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_DMAMUX1 {
  type Type = u32;
  #[inline(always)]
