#[doc = "Reader of register PCC_XRDC_PAC"]
pub type R = crate::R<u32, super::PCC_XRDC_PAC>;
#[doc = "Writer for register PCC_XRDC_PAC"]
pub type W = crate::W<u32, super::PCC_XRDC_PAC>;
#[doc = "Register PCC_XRDC_PAC `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_XRDC_PAC {
  type Type = u32;
  #[inline(always)]
