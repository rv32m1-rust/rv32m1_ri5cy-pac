#[doc = "Reader of register PCC_TPM3"]
pub type R = crate::R<u32, super::PCC_TPM3>;
#[doc = "Writer for register PCC_TPM3"]
pub type W = crate::W<u32, super::PCC_TPM3>;
#[doc = "Register PCC_TPM3 `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_TPM3 {
  type Type = u32;
  #[inline(always)]
