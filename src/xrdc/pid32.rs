#[doc = "Reader of register PID32"]
pub type R = crate::R<u32, super::PID32>;
#[doc = "Writer for register PID32"]
pub type W = crate::W<u32, super::PID32>;
#[doc = "Register PID32 `reset()`'s with value 0"]
impl crate::ResetValue for super::PID32 {
  type Type = u32;
  #[inline(always)]
