#[doc = "Reader of register TPM3"]
pub type R = crate::R<u32, super::TPM3>;
#[doc = "Writer for register TPM3"]
pub type W = crate::W<u32, super::TPM3>;
#[doc = "Register TPM3 `reset()`'s with value 0"]
impl crate::ResetValue for super::TPM3 {
  type Type = u32;
  #[inline(always)]
