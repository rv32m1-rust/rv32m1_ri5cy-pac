#[doc = "Reader of register DAC0"]
pub type R = crate::R<u32, super::DAC0>;
#[doc = "Writer for register DAC0"]
pub type W = crate::W<u32, super::DAC0>;
#[doc = "Register DAC0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DAC0 {
  type Type = u32;
  #[inline(always)]
