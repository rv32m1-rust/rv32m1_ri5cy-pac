#[doc = "Reader of register PKB2_[%s]"]
pub type R = crate::R<u32, super::PKB2_>;
#[doc = "Writer for register PKB2_[%s]"]
pub type W = crate::W<u32, super::PKB2_>;
#[doc = "Register PKB2_[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PKB2_ {
  type Type = u32;
  #[inline(always)]
