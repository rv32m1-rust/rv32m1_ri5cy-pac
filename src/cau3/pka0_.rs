#[doc = "Reader of register PKA0_[%s]"]
pub type R = crate::R<u32, super::PKA0_>;
#[doc = "Writer for register PKA0_[%s]"]
pub type W = crate::W<u32, super::PKA0_>;
#[doc = "Register PKA0_[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PKA0_ {
  type Type = u32;
  #[inline(always)]
