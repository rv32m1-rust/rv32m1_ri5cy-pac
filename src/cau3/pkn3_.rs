#[doc = "Reader of register PKN3_[%s]"]
pub type R = crate::R<u32, super::PKN3_>;
#[doc = "Writer for register PKN3_[%s]"]
pub type W = crate::W<u32, super::PKN3_>;
#[doc = "Register PKN3_[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PKN3_ {
  type Type = u32;
  #[inline(always)]
