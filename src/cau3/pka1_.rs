#[doc = "Reader of register PKA1_[%s]"]
pub type R = crate::R<u32, super::PKA1_>;
#[doc = "Writer for register PKA1_[%s]"]
pub type W = crate::W<u32, super::PKA1_>;
#[doc = "Register PKA1_[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PKA1_ {
  type Type = u32;
  #[inline(always)]
