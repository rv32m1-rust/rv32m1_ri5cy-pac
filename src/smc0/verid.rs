...
pub enum FEATURE_A {
  #[doc = "171: Default features supported"]
  FEATURE_171,
}
...
impl FEATURE_R {
  ...
  pub fn variant(&self) -> crate::Variant<u16, FEATURE_A> {
    use crate::Variant::*;
    match self.bits {
      171 => Val(FEATURE_A::FEATURE_171),
      i => Res(i),
    }
  }
  #[doc = "Checks if the value of the field is `FEATURE_171`"]
  #[inline(always)]
  pub fn is_feature_171(&self) -> bool {
    *self == FEATURE_A::FEATURE_171
  }
}
