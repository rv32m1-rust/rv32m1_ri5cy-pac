#[doc = "Reader of register PCC_MSCM"]
pub type R = crate::R<u32, super::PCC_MSCM>;
#[doc = "Writer for register PCC_MSCM"]
pub type W = crate::W<u32, super::PCC_MSCM>;
#[doc = "Register PCC_MSCM `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_MSCM {
  type Type = u32;
  #[inline(always)]
