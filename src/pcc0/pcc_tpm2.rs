#[doc = "Reader of register PCC_TPM2"]
pub type R = crate::R<u32, super::PCC_TPM2>;
#[doc = "Writer for register PCC_TPM2"]
pub type W = crate::W<u32, super::PCC_TPM2>;
#[doc = "Register PCC_TPM2 `reset()`'s with value 0x8000_0000"]
impl crate::ResetValue for super::PCC_TPM2 {
  type Type = u32;
  #[inline(always)]
